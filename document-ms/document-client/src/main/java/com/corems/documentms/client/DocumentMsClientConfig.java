...
public class DocumentMsClientConfig {
    ...
    @ConditionalOnMissingBean(name = "documentWebClient")
    public WebClient documentWebClient(WebClient.Builder inboundWebClientBuilder) {
    ...
    public ApiClient documentApiClient(@Qualifier("documentWebClient") WebClient webClient) {
